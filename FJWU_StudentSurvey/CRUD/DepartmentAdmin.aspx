        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body panel-body-table dataTables_wrapper no-footer">
                    ...
                    <asp:GridView  CssClass="table datatable table-hover" ID="DepartmentsGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="DepartmentId" DataSourceID="DepartmentsDataSource" AllowPaging="True" AllowSorting="True">
                        <Columns>
