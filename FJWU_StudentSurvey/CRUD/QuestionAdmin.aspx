        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body panel-body-table dataTables_wrapper no-footer">
                    ...
                    <asp:GridView ID="QuestionsGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="QuestionId" DataSourceID="QuestionsSource" AllowPaging="True" AllowSorting="True">
                        <Columns>
